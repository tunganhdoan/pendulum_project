...
class MainFrame(ttk.Frame):
    def __init__(self, container):
        ...
        def update():
            ...
            m = self.mass.get()
            g = self.gravity.get()
            theta_0 = self.initial_angle.get()
            v_0 = self.initial_angular_velocity.get()
            beta = self.damping.get()
            a = self.force_amplitude.get()
            f = self.force_frequency.get()
            dt = self.time_step.get()
            rate = self.time_rate.get()
            t_initial = 0
            t_stop = 30
        ...
        ttk.Scale(self, variable=self.length, command=length_slider_changed,
                  orient='horizontal', length=150, from_=1, to=50) \
            .grid(column=1, row=0, sticky=tk.W, **options)
        ttk.Spinbox(self, textvariable=self.length, command=length_spinbox_changed,
        ...
        ttk.Scale(self, variable=self.mass, command=mass_slider_changed,
                  orient='horizontal', length=150, from_=1, to=50) \
            .grid(column=1, row=1, sticky=tk.W, **options)
        ttk.Spinbox(self, textvariable=self.mass, command=mass_spinbox_changed,
                    increment=0.1, wrap=True, width=5, from_=1, to=50) \
        ...
        ttk.Spinbox(self, textvariable=self.gravity, command=gravity_spinbox_changed,
                    increment=0.1, wrap=True, width=5, from_=1, to=50) \
        ...
        ttk.Scale(self, variable=self.initial_angle, command=initial_angle_slider_changed,
                  orient='horizontal', length=150, from_=1, to=50) \
            .grid(column=1, row=3, sticky=tk.W, **options)
        ttk.Spinbox(self, textvariable=self.initial_angle, command=initial_angle_spinbox_changed,
                    increment=0.1, wrap=True, width=5, from_=1, to=50) \
        ...
        ttk.Scale(self, variable=self.initial_angular_velocity, command=initial_angular_velocity_slider_changed,
                  orient='horizontal', length=150, from_=1, to=50) \
            .grid(column=1, row=4, sticky=tk.W, **options)
        ttk.Spinbox(self, textvariable=self.initial_angular_velocity, command=initial_angular_velocity_spinbox_changed,
                    increment=0.1, wrap=True, width=5, from_=1, to=50) \
        ...
        ttk.Scale(self, variable=self.damping, command=damping_slider_changed,
                  orient='horizontal', length=150, from_=1, to=50) \
            .grid(column=1, row=5, sticky=tk.W, **options)
        ttk.Spinbox(self, textvariable=self.damping, command=damping_spinbox_changed,
                    increment=0.1, wrap=True, width=5, from_=1, to=50) \
        ...
        ttk.Scale(self, variable=self.force_amplitude, command=force_amplitude_slider_changed,
                  orient='horizontal', length=150, from_=1, to=50) \
            .grid(column=1, row=6, sticky=tk.W, **options)
        ttk.Spinbox(self, textvariable=self.force_amplitude, command=force_amplitude_spinbox_changed,
                    increment=0.1, wrap=True, width=5, from_=1, to=50) \
        ...
        ttk.Scale(self, variable=self.time_step, command=time_step_slider_changed,
                  orient='horizontal', length=150, from_=1, to=50) \
            .grid(column=1, row=8, sticky=tk.W, **options)
        ttk.Spinbox(self, textvariable=self.time_step, command=time_step_spinbox_changed,
                    increment=0.1, wrap=True, width=5, from_=1, to=50) \
        ...
        ttk.Scale(self, variable=self.time_rate, command=time_rate_slider_changed,
                  orient='horizontal', length=150, from_=1, to=50) \
            .grid(column=1, row=9, sticky=tk.W, **options)
        ttk.Spinbox(self, textvariable=self.time_rate, command=time_rate_spinbox_changed,
                    increment=0.1, wrap=True, width=5, from_=1, to=50) \
